 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.assignment.introsde/", wsdlLocation = "http://hidden-woodland-4363.herokuapp.com/soap/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://hidden-woodland-4363.herokuapp.com/soap/people?wsdl");
